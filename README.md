...
- To enroll, each player needs to deposit the right token amount, possibly zero.  ✔️ 
- To play, each Bob and Alice need to submit their unique move.  ✔️
- The contract decides and rewards the winner with all token wagered.  ✔️
...
- Include any tests using Hardhat. ❌ hardhat or fuzzing tests with achidna will cost ya extra :P
  
Now fork this repo and do it! ✔️
